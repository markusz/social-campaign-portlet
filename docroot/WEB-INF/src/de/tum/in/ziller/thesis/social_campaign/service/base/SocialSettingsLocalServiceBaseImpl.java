...
/**
 * The base implementation of the social settings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.SocialSettingsLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.SocialSettingsLocalServiceUtil} to access the social settings local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.SocialSettingsLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.SocialSettingsLocalServiceUtil
 * @generated
 */
public abstract class SocialSettingsLocalServiceBaseImpl
	implements SocialSettingsLocalService {
	/**
	 * Adds the social settings to the database. Also notifies the appropriate model listeners.
	 *
	 * @param socialSettings the social settings to add
	 * @return the social settings that was added
	 * @throws SystemException if a system exception occurred
	 */
	public SocialSettings addSocialSettings(SocialSettings socialSettings)
		throws SystemException {
		socialSettings.setNew(true);

		return socialSettingsPersistence.update(socialSettings, false);
	}
	 ...
	 */
	public SocialSettings createSocialSettings(long userProfileId) {
		return socialSettingsPersistence.create(userProfileId);
	}

	/**
	 * Deletes the social settings with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param userProfileId the primary key of the social settings to delete
	 * @throws PortalException if a social settings with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteSocialSettings(long userProfileId)
		throws PortalException, SystemException {
		socialSettingsPersistence.remove(userProfileId);
	}

	/**
	 * Deletes the social settings from the database. Also notifies the appropriate model listeners.
	 *
	 * @param socialSettings the social settings to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteSocialSettings(SocialSettings socialSettings)
		throws SystemException {
		socialSettingsPersistence.remove(socialSettings);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return socialSettingsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return socialSettingsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the social settings with the primary key.
	 *
	 * @param userProfileId the primary key of the social settings to get
	 * @return the social settings
	 * @throws PortalException if a social settings with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public SocialSettings getSocialSettings(long userProfileId)
		throws PortalException, SystemException {
		return socialSettingsPersistence.findByPrimaryKey(userProfileId);
	}

	/**
	 * Gets a range of all the social settingses.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<SocialSettings> getSocialSettingses(int start, int end)
		throws SystemException {
		return socialSettingsPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of social settingses.
	 *
	 * @return the number of social settingses
	 * @throws SystemException if a system exception occurred
	 */
	public int getSocialSettingsesCount() throws SystemException {
		return socialSettingsPersistence.countAll();
	}

	/**
	 * Updates the social settings in the database. Also notifies the appropriate model listeners.
	 *
	 * @param socialSettings the social settings to update
	 * @return the social settings that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public SocialSettings updateSocialSettings(SocialSettings socialSettings)
		throws SystemException {
		socialSettings.setNew(false);

		return socialSettingsPersistence.update(socialSettings, true);
	}
	 ...
	 *
	 * @param socialSettings the social settings to update
	 * @param merge whether to merge the social settings with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the social settings that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public SocialSettings updateSocialSettings(SocialSettings socialSettings,
		...
		return socialSettingsPersistence.update(socialSettings, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = socialSettingsPersistence.getDataSource();
