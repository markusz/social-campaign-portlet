...
/**
 * The base implementation of the general settings local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.GeneralSettingsLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.GeneralSettingsLocalServiceUtil} to access the general settings local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.GeneralSettingsLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.GeneralSettingsLocalServiceUtil
 * @generated
 */
public abstract class GeneralSettingsLocalServiceBaseImpl
	implements GeneralSettingsLocalService {
	/**
	 * Adds the general settings to the database. Also notifies the appropriate model listeners.
	 *
	 * @param generalSettings the general settings to add
	 * @return the general settings that was added
	 * @throws SystemException if a system exception occurred
	 */
	public GeneralSettings addGeneralSettings(GeneralSettings generalSettings)
		throws SystemException {
		generalSettings.setNew(true);

		return generalSettingsPersistence.update(generalSettings, false);
	}
	 ...
	 */
	public GeneralSettings createGeneralSettings(long userProfileId) {
		return generalSettingsPersistence.create(userProfileId);
	}

	/**
	 * Deletes the general settings with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param userProfileId the primary key of the general settings to delete
	 * @throws PortalException if a general settings with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteGeneralSettings(long userProfileId)
		throws PortalException, SystemException {
		generalSettingsPersistence.remove(userProfileId);
	}

	/**
	 * Deletes the general settings from the database. Also notifies the appropriate model listeners.
	 *
	 * @param generalSettings the general settings to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteGeneralSettings(GeneralSettings generalSettings)
		throws SystemException {
		generalSettingsPersistence.remove(generalSettings);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return generalSettingsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return generalSettingsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the general settings with the primary key.
	 *
	 * @param userProfileId the primary key of the general settings to get
	 * @return the general settings
	 * @throws PortalException if a general settings with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public GeneralSettings getGeneralSettings(long userProfileId)
		throws PortalException, SystemException {
		return generalSettingsPersistence.findByPrimaryKey(userProfileId);
	}

	/**
	 * Gets a range of all the general settingses.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<GeneralSettings> getGeneralSettingses(int start, int end)
		throws SystemException {
		return generalSettingsPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of general settingses.
	 *
	 * @return the number of general settingses
	 * @throws SystemException if a system exception occurred
	 */
	public int getGeneralSettingsesCount() throws SystemException {
		return generalSettingsPersistence.countAll();
	}

	/**
	 * Updates the general settings in the database. Also notifies the appropriate model listeners.
	 *
	 * @param generalSettings the general settings to update
	 * @return the general settings that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public GeneralSettings updateGeneralSettings(
		GeneralSettings generalSettings) throws SystemException {
		generalSettings.setNew(false);

		return generalSettingsPersistence.update(generalSettings, true);
	}
	 ...
	 *
	 * @param generalSettings the general settings to update
	 * @param merge whether to merge the general settings with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the general settings that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public GeneralSettings updateGeneralSettings(
		GeneralSettings generalSettings, boolean merge)
		throws SystemException {
		generalSettings.setNew(false);

		return generalSettingsPersistence.update(generalSettings, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = generalSettingsPersistence.getDataSource();
