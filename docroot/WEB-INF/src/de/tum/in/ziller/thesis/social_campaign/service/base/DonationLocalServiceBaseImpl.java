...
/**
 * The base implementation of the donation local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.DonationLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.DonationLocalServiceUtil} to access the donation local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.DonationLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.DonationLocalServiceUtil
 * @generated
 */
public abstract class DonationLocalServiceBaseImpl
	implements DonationLocalService {
	/**
	 * Adds the donation to the database. Also notifies the appropriate model listeners.
	 *
	 * @param donation the donation to add
	 * @return the donation that was added
	 * @throws SystemException if a system exception occurred
	 */
	public Donation addDonation(Donation donation) throws SystemException {
		donation.setNew(true);

		return donationPersistence.update(donation, false);
	}
	 ...
	 */
	public Donation createDonation(long donationId) {
		return donationPersistence.create(donationId);
	}

	/**
	 * Deletes the donation with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param donationId the primary key of the donation to delete
	 * @throws PortalException if a donation with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDonation(long donationId)
		throws PortalException, SystemException {
		donationPersistence.remove(donationId);
	}

	/**
	 * Deletes the donation from the database. Also notifies the appropriate model listeners.
	 *
	 * @param donation the donation to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteDonation(Donation donation) throws SystemException {
		donationPersistence.remove(donation);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return donationPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return donationPersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return donationPersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return donationPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the donation with the primary key.
	 *
	 * @param donationId the primary key of the donation to get
	 * @return the donation
	 * @throws PortalException if a donation with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public Donation getDonation(long donationId)
		throws PortalException, SystemException {
		return donationPersistence.findByPrimaryKey(donationId);
	}

	/**
	 * Gets a range of all the donations.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<Donation> getDonations(int start, int end)
		throws SystemException {
		return donationPersistence.findAll(start, end);
	}
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public int getDonationsCount() throws SystemException {
		return donationPersistence.countAll();
	}

	/**
	 * Updates the donation in the database. Also notifies the appropriate model listeners.
	 *
	 * @param donation the donation to update
	 * @return the donation that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public Donation updateDonation(Donation donation) throws SystemException {
		donation.setNew(false);

		return donationPersistence.update(donation, true);
	}
	 ...
	 *
	 * @param donation the donation to update
	 * @param merge whether to merge the donation with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the donation that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public Donation updateDonation(Donation donation, boolean merge)
		throws SystemException {
		donation.setNew(false);

		return donationPersistence.update(donation, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = donationPersistence.getDataSource();
