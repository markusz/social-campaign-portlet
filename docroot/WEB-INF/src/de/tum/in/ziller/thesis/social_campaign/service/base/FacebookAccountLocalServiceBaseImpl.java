...
/**
 * The base implementation of the facebook account local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.FacebookAccountLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.FacebookAccountLocalServiceUtil} to access the facebook account local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.FacebookAccountLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.FacebookAccountLocalServiceUtil
 * @generated
 */
public abstract class FacebookAccountLocalServiceBaseImpl
	implements FacebookAccountLocalService {
	/**
	 * Adds the facebook account to the database. Also notifies the appropriate model listeners.
	 *
	 * @param facebookAccount the facebook account to add
	 * @return the facebook account that was added
	...
	public FacebookAccount addFacebookAccount(FacebookAccount facebookAccount)
		...
		return facebookAccountPersistence.update(facebookAccount, false);
	}
	 ...
	 */
	public FacebookAccount createFacebookAccount(long userProfileId) {
		return facebookAccountPersistence.create(userProfileId);
	}

	/**
	 * Deletes the facebook account with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param userProfileId the primary key of the facebook account to delete
	 * @throws PortalException if a facebook account with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteFacebookAccount(long userProfileId)
		throws PortalException, SystemException {
		facebookAccountPersistence.remove(userProfileId);
	}

	/**
	 * Deletes the facebook account from the database. Also notifies the appropriate model listeners.
	 *
	 * @param facebookAccount the facebook account to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteFacebookAccount(FacebookAccount facebookAccount)
		throws SystemException {
		facebookAccountPersistence.remove(facebookAccount);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return facebookAccountPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facebookAccountPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the facebook account with the primary key.
	 *
	 * @param userProfileId the primary key of the facebook account to get
	 * @return the facebook account
	 * @throws PortalException if a facebook account with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public FacebookAccount getFacebookAccount(long userProfileId)
		throws PortalException, SystemException {
		return facebookAccountPersistence.findByPrimaryKey(userProfileId);
	}

	/**
	 * Gets a range of all the facebook accounts.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacebookAccount> getFacebookAccounts(int start, int end)
		throws SystemException {
		return facebookAccountPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of facebook accounts.
	 *
	 * @return the number of facebook accounts
	 * @throws SystemException if a system exception occurred
	 */
	public int getFacebookAccountsCount() throws SystemException {
		return facebookAccountPersistence.countAll();
	}

	/**
	 * Updates the facebook account in the database. Also notifies the appropriate model listeners.
	 *
	 * @param facebookAccount the facebook account to update
	 * @return the facebook account that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public FacebookAccount updateFacebookAccount(
		FacebookAccount facebookAccount) throws SystemException {
		facebookAccount.setNew(false);

		return facebookAccountPersistence.update(facebookAccount, true);
	}
	 ...
	 *
	 * @param facebookAccount the facebook account to update
	 * @param merge whether to merge the facebook account with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the facebook account that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public FacebookAccount updateFacebookAccount(
		FacebookAccount facebookAccount, boolean merge)
		throws SystemException {
		facebookAccount.setNew(false);

		return facebookAccountPersistence.update(facebookAccount, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facebookAccountPersistence.getDataSource();
