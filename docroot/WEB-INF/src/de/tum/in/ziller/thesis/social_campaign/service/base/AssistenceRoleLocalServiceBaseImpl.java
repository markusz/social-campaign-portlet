...
/**
 * The base implementation of the assistence role local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.AssistenceRoleLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.AssistenceRoleLocalServiceUtil} to access the assistence role local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.AssistenceRoleLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.AssistenceRoleLocalServiceUtil
 * @generated
 */
public abstract class AssistenceRoleLocalServiceBaseImpl
	implements AssistenceRoleLocalService {
	/**
	 * Adds the assistence role to the database. Also notifies the appropriate model listeners.
	 *
	 * @param assistenceRole the assistence role to add
	 * @return the assistence role that was added
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRole addAssistenceRole(AssistenceRole assistenceRole)
		throws SystemException {
		assistenceRole.setNew(true);

		return assistenceRolePersistence.update(assistenceRole, false);
	}
	 ...
	 */
	public AssistenceRole createAssistenceRole(long roleId) {
		return assistenceRolePersistence.create(roleId);
	}

	/**
	 * Deletes the assistence role with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param roleId the primary key of the assistence role to delete
	 * @throws PortalException if a assistence role with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteAssistenceRole(long roleId)
		throws PortalException, SystemException {
		assistenceRolePersistence.remove(roleId);
	}

	/**
	 * Deletes the assistence role from the database. Also notifies the appropriate model listeners.
	 *
	 * @param assistenceRole the assistence role to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteAssistenceRole(AssistenceRole assistenceRole)
		throws SystemException {
		assistenceRolePersistence.remove(assistenceRole);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assistenceRolePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assistenceRolePersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the assistence role with the primary key.
	 *
	 * @param roleId the primary key of the assistence role to get
	 * @return the assistence role
	 * @throws PortalException if a assistence role with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRole getAssistenceRole(long roleId)
		throws PortalException, SystemException {
		return assistenceRolePersistence.findByPrimaryKey(roleId);
	}

	/**
	 * Gets a range of all the assistence roles.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssistenceRole> getAssistenceRoles(int start, int end)
		throws SystemException {
		return assistenceRolePersistence.findAll(start, end);
	}

	/**
	 * Gets the number of assistence roles.
	 *
	 * @return the number of assistence roles
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssistenceRolesCount() throws SystemException {
		return assistenceRolePersistence.countAll();
	}

	/**
	 * Updates the assistence role in the database. Also notifies the appropriate model listeners.
	 *
	 * @param assistenceRole the assistence role to update
	 * @return the assistence role that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRole updateAssistenceRole(AssistenceRole assistenceRole)
		throws SystemException {
		assistenceRole.setNew(false);

		return assistenceRolePersistence.update(assistenceRole, true);
	}
	 ...
	 *
	 * @param assistenceRole the assistence role to update
	 * @param merge whether to merge the assistence role with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the assistence role that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRole updateAssistenceRole(AssistenceRole assistenceRole,
		...
		return assistenceRolePersistence.update(assistenceRole, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assistenceRolePersistence.getDataSource();
