...
/**
 * The base implementation of the google credentials local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.GoogleCredentialsLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.GoogleCredentialsLocalServiceUtil} to access the google credentials local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.GoogleCredentialsLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.GoogleCredentialsLocalServiceUtil
 * @generated
 */
public abstract class GoogleCredentialsLocalServiceBaseImpl
	implements GoogleCredentialsLocalService {
	/**
	 * Adds the google credentials to the database. Also notifies the appropriate model listeners.
	 *
	 * @param googleCredentials the google credentials to add
	 * @return the google credentials that was added
	 * @throws SystemException if a system exception occurred
	 */
	public GoogleCredentials addGoogleCredentials(
		GoogleCredentials googleCredentials) throws SystemException {
		googleCredentials.setNew(true);

		return googleCredentialsPersistence.update(googleCredentials, false);
	}
	 ...
	 */
	public GoogleCredentials createGoogleCredentials(long userId) {
		return googleCredentialsPersistence.create(userId);
	}

	/**
	 * Deletes the google credentials with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param userId the primary key of the google credentials to delete
	 * @throws PortalException if a google credentials with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteGoogleCredentials(long userId)
		throws PortalException, SystemException {
		googleCredentialsPersistence.remove(userId);
	}

	/**
	 * Deletes the google credentials from the database. Also notifies the appropriate model listeners.
	 *
	 * @param googleCredentials the google credentials to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteGoogleCredentials(GoogleCredentials googleCredentials)
		throws SystemException {
		googleCredentialsPersistence.remove(googleCredentials);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return googleCredentialsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return googleCredentialsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the google credentials with the primary key.
	 *
	 * @param userId the primary key of the google credentials to get
	...
	public GoogleCredentials getGoogleCredentials(long userId)
		throws PortalException, SystemException {
		return googleCredentialsPersistence.findByPrimaryKey(userId);
	}

	/**
	 * Gets a range of all the google credentialses.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<GoogleCredentials> getGoogleCredentialses(int start, int end)
		throws SystemException {
		return googleCredentialsPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of google credentialses.
	 *
	 * @return the number of google credentialses
	 * @throws SystemException if a system exception occurred
	 */
	public int getGoogleCredentialsesCount() throws SystemException {
		return googleCredentialsPersistence.countAll();
	}

	/**
	 * Updates the google credentials in the database. Also notifies the appropriate model listeners.
	 *
	 * @param googleCredentials the google credentials to update
	 * @return the google credentials that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public GoogleCredentials updateGoogleCredentials(
		GoogleCredentials googleCredentials) throws SystemException {
		googleCredentials.setNew(false);

		return googleCredentialsPersistence.update(googleCredentials, true);
	}
	 ...
	 *
	 * @param googleCredentials the google credentials to update
	 * @param merge whether to merge the google credentials with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the google credentials that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public GoogleCredentials updateGoogleCredentials(
		GoogleCredentials googleCredentials, boolean merge)
		throws SystemException {
		googleCredentials.setNew(false);

		return googleCredentialsPersistence.update(googleCredentials, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = googleCredentialsPersistence.getDataSource();
