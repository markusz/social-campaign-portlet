 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.EventLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.EventLocalServiceUtil} to access the Event local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.EventLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.EventLocalServiceUtil
 * @generated
 */
public abstract class EventLocalServiceBaseImpl implements EventLocalService {
	/**
	...
	/**
	 * Gets the Event with the primary key.
	 *
	 * @param eventId the primary key of the Event to get
	 * @return the Event
	 * @throws PortalException if a Event with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Gets a range of all the Events.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Updates the Event in the database. Also notifies the appropriate model listeners.
	 *
	...
	public Event updateEvent(Event event) throws SystemException {
		...
		return eventPersistence.update(event, true);
	}
