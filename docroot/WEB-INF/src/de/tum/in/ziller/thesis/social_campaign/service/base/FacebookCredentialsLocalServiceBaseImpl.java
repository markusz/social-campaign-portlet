...
/**
 * The base implementation of the facebook credentials local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.FacebookCredentialsLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.FacebookCredentialsLocalServiceUtil} to access the facebook credentials local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.FacebookCredentialsLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.FacebookCredentialsLocalServiceUtil
 * @generated
 */
public abstract class FacebookCredentialsLocalServiceBaseImpl
	implements FacebookCredentialsLocalService {
	/**
	 * Adds the facebook credentials to the database. Also notifies the appropriate model listeners.
	 *
	 * @param facebookCredentials the facebook credentials to add
	 * @return the facebook credentials that was added
	 * @throws SystemException if a system exception occurred
	 */
	public FacebookCredentials addFacebookCredentials(
		FacebookCredentials facebookCredentials) throws SystemException {
		facebookCredentials.setNew(true);

		return facebookCredentialsPersistence.update(facebookCredentials, false);
	}
	 ...
	 */
	public FacebookCredentials createFacebookCredentials(long userId) {
		return facebookCredentialsPersistence.create(userId);
	}

	/**
	 * Deletes the facebook credentials with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param userId the primary key of the facebook credentials to delete
	 * @throws PortalException if a facebook credentials with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteFacebookCredentials(long userId)
		throws PortalException, SystemException {
		facebookCredentialsPersistence.remove(userId);
	}

	/**
	 * Deletes the facebook credentials from the database. Also notifies the appropriate model listeners.
	 *
	 * @param facebookCredentials the facebook credentials to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteFacebookCredentials(
		FacebookCredentials facebookCredentials) throws SystemException {
		facebookCredentialsPersistence.remove(facebookCredentials);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return facebookCredentialsPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return facebookCredentialsPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the facebook credentials with the primary key.
	 *
	 * @param userId the primary key of the facebook credentials to get
	 * @return the facebook credentials
	 * @throws PortalException if a facebook credentials with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public FacebookCredentials getFacebookCredentials(long userId)
		throws PortalException, SystemException {
		return facebookCredentialsPersistence.findByPrimaryKey(userId);
	}

	/**
	 * Gets a range of all the facebook credentialses.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<FacebookCredentials> getFacebookCredentialses(int start, int end)
		throws SystemException {
		return facebookCredentialsPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of facebook credentialses.
	 *
	 * @return the number of facebook credentialses
	 * @throws SystemException if a system exception occurred
	 */
	public int getFacebookCredentialsesCount() throws SystemException {
		return facebookCredentialsPersistence.countAll();
	}

	/**
	 * Updates the facebook credentials in the database. Also notifies the appropriate model listeners.
	 *
	 * @param facebookCredentials the facebook credentials to update
	 * @return the facebook credentials that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public FacebookCredentials updateFacebookCredentials(
		FacebookCredentials facebookCredentials) throws SystemException {
		facebookCredentials.setNew(false);

		return facebookCredentialsPersistence.update(facebookCredentials, true);
	}
	 ...
	 *
	 * @param facebookCredentials the facebook credentials to update
	 * @param merge whether to merge the facebook credentials with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the facebook credentials that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public FacebookCredentials updateFacebookCredentials(
		FacebookCredentials facebookCredentials, boolean merge)
		throws SystemException {
		facebookCredentials.setNew(false);

		return facebookCredentialsPersistence.update(facebookCredentials, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = facebookCredentialsPersistence.getDataSource();
