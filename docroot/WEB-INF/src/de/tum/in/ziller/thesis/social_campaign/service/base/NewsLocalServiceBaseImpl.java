 ...
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.NewsLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.NewsLocalServiceUtil} to access the news local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.NewsLocalServiceImpl
...
public abstract class NewsLocalServiceBaseImpl implements NewsLocalService {
	...
	public News addNews(News news) throws SystemException {
		...
		return newsPersistence.update(news, false);
	}
	 ...
	 *
	 * @param newsId the primary key of the news to delete
	...
	/**
	 * Gets the news with the primary key.
	 *
	 * @param newsId the primary key of the news to get
	 * @return the news
	 * @throws PortalException if a news with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	...
	/**
	 * Gets a range of all the newses.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	...
	/**
	 * Updates the news in the database. Also notifies the appropriate model listeners.
	 *
	...
	public News updateNews(News news) throws SystemException {
		...
		return newsPersistence.update(news, true);
	}
	...
	public News updateNews(News news, boolean merge) throws SystemException {
		...
		return newsPersistence.update(news, merge);
	}
