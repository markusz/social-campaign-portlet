...
/**
 * The base implementation of the assistence request local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.AssistenceRequestLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.AssistenceRequestLocalServiceUtil} to access the assistence request local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.AssistenceRequestLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.AssistenceRequestLocalServiceUtil
 * @generated
 */
public abstract class AssistenceRequestLocalServiceBaseImpl
	implements AssistenceRequestLocalService {
	/**
	 * Adds the assistence request to the database. Also notifies the appropriate model listeners.
	 *
	 * @param assistenceRequest the assistence request to add
	 * @return the assistence request that was added
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRequest addAssistenceRequest(
		AssistenceRequest assistenceRequest) throws SystemException {
		assistenceRequest.setNew(true);

		return assistenceRequestPersistence.update(assistenceRequest, false);
	}
	 ...
	 */
	public AssistenceRequest createAssistenceRequest(
		AssistenceRequestPK assistenceRequestPK) {
		return assistenceRequestPersistence.create(assistenceRequestPK);
	}

	/**
	 * Deletes the assistence request with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param assistenceRequestPK the primary key of the assistence request to delete
	 * @throws PortalException if a assistence request with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteAssistenceRequest(AssistenceRequestPK assistenceRequestPK)
		throws PortalException, SystemException {
		assistenceRequestPersistence.remove(assistenceRequestPK);
	}

	/**
	 * Deletes the assistence request from the database. Also notifies the appropriate model listeners.
	 *
	 * @param assistenceRequest the assistence request to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteAssistenceRequest(AssistenceRequest assistenceRequest)
		throws SystemException {
		assistenceRequestPersistence.remove(assistenceRequest);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return assistenceRequestPersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return assistenceRequestPersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the assistence request with the primary key.
	 *
	 * @param assistenceRequestPK the primary key of the assistence request to get
	 * @return the assistence request
	 * @throws PortalException if a assistence request with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRequest getAssistenceRequest(
		AssistenceRequestPK assistenceRequestPK)
		throws PortalException, SystemException {
		return assistenceRequestPersistence.findByPrimaryKey(assistenceRequestPK);
	}

	/**
	 * Gets a range of all the assistence requests.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<AssistenceRequest> getAssistenceRequests(int start, int end)
		throws SystemException {
		return assistenceRequestPersistence.findAll(start, end);
	}

	/**
	 * Gets the number of assistence requests.
	 *
	 * @return the number of assistence requests
	 * @throws SystemException if a system exception occurred
	 */
	public int getAssistenceRequestsCount() throws SystemException {
		return assistenceRequestPersistence.countAll();
	}

	/**
	 * Updates the assistence request in the database. Also notifies the appropriate model listeners.
	 *
	 * @param assistenceRequest the assistence request to update
	 * @return the assistence request that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRequest updateAssistenceRequest(
		AssistenceRequest assistenceRequest) throws SystemException {
		assistenceRequest.setNew(false);

		return assistenceRequestPersistence.update(assistenceRequest, true);
	}
	 ...
	 *
	 * @param assistenceRequest the assistence request to update
	 * @param merge whether to merge the assistence request with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the assistence request that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public AssistenceRequest updateAssistenceRequest(
		AssistenceRequest assistenceRequest, boolean merge)
		throws SystemException {
		assistenceRequest.setNew(false);

		return assistenceRequestPersistence.update(assistenceRequest, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = assistenceRequestPersistence.getDataSource();
