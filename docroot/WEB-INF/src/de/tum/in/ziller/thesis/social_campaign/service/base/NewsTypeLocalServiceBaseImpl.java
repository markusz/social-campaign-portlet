...
/**
 * The base implementation of the news type local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.NewsTypeLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.NewsTypeLocalServiceUtil} to access the news type local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.NewsTypeLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.NewsTypeLocalServiceUtil
 * @generated
 */
public abstract class NewsTypeLocalServiceBaseImpl
	implements NewsTypeLocalService {
	/**
	 * Adds the news type to the database. Also notifies the appropriate model listeners.
	 *
	 * @param newsType the news type to add
	 * @return the news type that was added
	 * @throws SystemException if a system exception occurred
	 */
	public NewsType addNewsType(NewsType newsType) throws SystemException {
		newsType.setNew(true);

		return newsTypePersistence.update(newsType, false);
	}
	 ...
	 */
	public NewsType createNewsType(long newsTypeId) {
		return newsTypePersistence.create(newsTypeId);
	}

	/**
	 * Deletes the news type with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param newsTypeId the primary key of the news type to delete
	 * @throws PortalException if a news type with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteNewsType(long newsTypeId)
		throws PortalException, SystemException {
		newsTypePersistence.remove(newsTypeId);
	}

	/**
	 * Deletes the news type from the database. Also notifies the appropriate model listeners.
	 *
	 * @param newsType the news type to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteNewsType(NewsType newsType) throws SystemException {
		newsTypePersistence.remove(newsType);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		...
		return newsTypePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end)
		throws SystemException {
		return newsTypePersistence.findWithDynamicQuery(dynamicQuery, start, end);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery, int start, int end,
		...
		return newsTypePersistence.findWithDynamicQuery(dynamicQuery, start,
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return newsTypePersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the news type with the primary key.
	 *
	 * @param newsTypeId the primary key of the news type to get
	 * @return the news type
	 * @throws PortalException if a news type with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public NewsType getNewsType(long newsTypeId)
		throws PortalException, SystemException {
		return newsTypePersistence.findByPrimaryKey(newsTypeId);
	}

	/**
	 * Gets a range of all the news types.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<NewsType> getNewsTypes(int start, int end)
		throws SystemException {
		return newsTypePersistence.findAll(start, end);
	}

	/**
	 * Gets the number of news types.
	 *
	 * @return the number of news types
	 * @throws SystemException if a system exception occurred
	 */
	public int getNewsTypesCount() throws SystemException {
		return newsTypePersistence.countAll();
	}

	/**
	 * Updates the news type in the database. Also notifies the appropriate model listeners.
	 *
	 * @param newsType the news type to update
	 * @return the news type that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public NewsType updateNewsType(NewsType newsType) throws SystemException {
		newsType.setNew(false);

		return newsTypePersistence.update(newsType, true);
	}
	 ...
	 *
	 * @param newsType the news type to update
	 * @param merge whether to merge the news type with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the news type that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public NewsType updateNewsType(NewsType newsType, boolean merge)
		throws SystemException {
		newsType.setNew(false);

		return newsTypePersistence.update(newsType, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = newsTypePersistence.getDataSource();
