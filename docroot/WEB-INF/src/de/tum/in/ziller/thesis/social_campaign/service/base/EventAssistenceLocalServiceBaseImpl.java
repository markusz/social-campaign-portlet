...
/**
 * The base implementation of the event assistence local service.
 *
 * <p>
 * This implementation exists only as a container for the default service methods generated by ServiceBuilder. All custom service methods should be put in {@link de.tum.in.ziller.thesis.social_campaign.service.impl.EventAssistenceLocalServiceImpl}.
 * </p>
 *
 * <p>
 * Never modify or reference this class directly. Always use {@link de.tum.in.ziller.thesis.social_campaign.service.EventAssistenceLocalServiceUtil} to access the event assistence local service.
 * </p>
 *
 * @author Markus Ziller
 * @see de.tum.in.ziller.thesis.social_campaign.service.impl.EventAssistenceLocalServiceImpl
 * @see de.tum.in.ziller.thesis.social_campaign.service.EventAssistenceLocalServiceUtil
 * @generated
 */
public abstract class EventAssistenceLocalServiceBaseImpl
	implements EventAssistenceLocalService {
	/**
	 * Adds the event assistence to the database. Also notifies the appropriate model listeners.
	 *
	 * @param eventAssistence the event assistence to add
	 * @return the event assistence that was added
	 * @throws SystemException if a system exception occurred
	 */
	public EventAssistence addEventAssistence(EventAssistence eventAssistence)
		throws SystemException {
		eventAssistence.setNew(true);

		return eventAssistencePersistence.update(eventAssistence, false);
	}
	 ...
	 */
	public EventAssistence createEventAssistence(
		EventAssistencePK eventAssistencePK) {
		return eventAssistencePersistence.create(eventAssistencePK);
	}

	/**
	 * Deletes the event assistence with the primary key from the database. Also notifies the appropriate model listeners.
	 *
	 * @param eventAssistencePK the primary key of the event assistence to delete
	 * @throws PortalException if a event assistence with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteEventAssistence(EventAssistencePK eventAssistencePK)
		throws PortalException, SystemException {
		eventAssistencePersistence.remove(eventAssistencePK);
	}

	/**
	 * Deletes the event assistence from the database. Also notifies the appropriate model listeners.
	 *
	 * @param eventAssistence the event assistence to delete
	 * @throws SystemException if a system exception occurred
	 */
	public void deleteEventAssistence(EventAssistence eventAssistence)
		throws SystemException {
		eventAssistencePersistence.remove(eventAssistence);
	}
	...
	public List dynamicQuery(DynamicQuery dynamicQuery)
		throws SystemException {
		return eventAssistencePersistence.findWithDynamicQuery(dynamicQuery);
	}
	...
	public long dynamicQueryCount(DynamicQuery dynamicQuery)
		throws SystemException {
		return eventAssistencePersistence.countWithDynamicQuery(dynamicQuery);
	}

	/**
	 * Gets the event assistence with the primary key.
	 *
	 * @param eventAssistencePK the primary key of the event assistence to get
	 * @return the event assistence
	 * @throws PortalException if a event assistence with the primary key could not be found
	 * @throws SystemException if a system exception occurred
	 */
	public EventAssistence getEventAssistence(
		EventAssistencePK eventAssistencePK)
		throws PortalException, SystemException {
		return eventAssistencePersistence.findByPrimaryKey(eventAssistencePK);
	}

	/**
	 * Gets a range of all the event assistences.
	 *
	 * <p>
	 * Useful when paginating results. Returns a maximum of <code>end - start</code> instances. <code>start</code> and <code>end</code> are not primary keys, they are indexes in the result set. Thus, <code>0</code> refers to the first result in the set. Setting both <code>start</code> and <code>end</code> to {@link com.liferay.portal.kernel.dao.orm.QueryUtil#ALL_POS} will return the full result set.
	 * </p>
	 ...
	 * @throws SystemException if a system exception occurred
	 */
	public List<EventAssistence> getEventAssistences(int start, int end)
		throws SystemException {
		return eventAssistencePersistence.findAll(start, end);
	}

	/**
	 * Gets the number of event assistences.
	 *
	 * @return the number of event assistences
	 * @throws SystemException if a system exception occurred
	 */
	public int getEventAssistencesCount() throws SystemException {
		return eventAssistencePersistence.countAll();
	}

	/**
	 * Updates the event assistence in the database. Also notifies the appropriate model listeners.
	 *
	 * @param eventAssistence the event assistence to update
	 * @return the event assistence that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public EventAssistence updateEventAssistence(
		EventAssistence eventAssistence) throws SystemException {
		eventAssistence.setNew(false);

		return eventAssistencePersistence.update(eventAssistence, true);
	}
	 ...
	 *
	 * @param eventAssistence the event assistence to update
	 * @param merge whether to merge the event assistence with the current session. See {@link com.liferay.portal.service.persistence.BatchSession#update(com.liferay.portal.kernel.dao.orm.Session, com.liferay.portal.model.BaseModel, boolean)} for an explanation.
	 * @return the event assistence that was updated
	 * @throws SystemException if a system exception occurred
	 */
	public EventAssistence updateEventAssistence(
		EventAssistence eventAssistence, boolean merge)
		throws SystemException {
		eventAssistence.setNew(false);

		return eventAssistencePersistence.update(eventAssistence, merge);
	}
	...
	protected void runSQL(String sql) throws SystemException {
		try {
			DataSource dataSource = eventAssistencePersistence.getDataSource();
